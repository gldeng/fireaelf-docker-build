...
COPY --from=gldeng/aelf-test-node:shac236654 /app/appsettings* /app
COPY --from=gldeng/aelf-test-node:shac236654 /app/AElf.Launcher.* /app
COPY --from=gldeng/aelf-test-node:shac236654 /app/AElf.Firehose.* /app
